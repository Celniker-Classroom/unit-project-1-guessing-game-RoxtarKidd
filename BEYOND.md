In styles.css (lines 1–232), I focused on the overall visual design and layout of the site. The .game-card element uses float positioning to center the main content in the middle of the page, creating a clean focal point. I also adjusted margins throughout the file to fine-tune spacing and improve the overall appearance. To enhance the design, I incorporated color styling and linear gradients, as well as hover effects—for example, buttons slightly shift upward when hovered over to give a more interactive feel. Additionally, I used overflow: hidden and height: 100% to prevent unwanted scrolling and ensure the layout stays consistent.
